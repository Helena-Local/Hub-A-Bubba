package org.helenalocal.app.provider;
...
public class ItemProvider extends ContentProvider {
    ...
    public static final Uri CONTENT_URI = Uri.parse("content://org.helenalocal.provider.itemprovider/items");
    ...
    static {
        ...
        _uriMatcher.addURI("org.helenalocal.provider.itemprovider", "items", ITEMS);
        _uriMatcher.addURI("org.helenalocal.provider.itemprovider", "items/#", ITEM_ID);
    }
    ...
    public String getType(Uri uri) {
        ...
        switch (_uriMatcher.match(uri)) {
            case ITEMS:
                type = "vnd.android.cursor.dir/vnd.org.helenalocal.provider.itemprovider";
                break;
